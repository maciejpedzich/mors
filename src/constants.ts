...
export const INFRINGEMENTS: Record<number, string> = {
  ...
  13: 'Ignoring a drive through penalty',
  ...
  20: 'Receiving too many penalties',
  ...
  27: 'Running wide and gaining minor advantage',
  28: 'Running wide and gaining significant advantage',
  29: 'Running wide and gaining extreme advantage',
  30: 'Lap invalidated for wall riding',
  31: 'Lap invalidated for using flashback',
  32: 'Lap invalidated for resetting to track',
  ...
  44: 'Black flag timer',
  45: 'Failing to serve a stop go penalty',
  46: 'Failing to serve a drive through penalty',
